questions = [
	//Economic
	    {
	        "question": "Communism is an ideal that would never work in practice.",
	        "effect": {
	        "econ": 10,
	        "govt": 0,
	        "econsys": 0,
      ...
      {
	        "question": "Wages are often fair, as employers know best what a worker's labour is worth.",
	        "effect": {
	        "econ": 10,
	        "govt": 0,
	        "econsys": 10,
	    ...
	    },
	{
      ...
      {
	        "question": "Taxation for the rich should be lowered, or even abolished.",
	        "effect": {
	        "econ": 10,
	        "govt": 0,
	        "econsys": 0,
      ...
      {
	        "question": "Economic inequality is still a very serious problem.",
	        "effect": {
	        "econ": 10,
	        "govt": 0,
	        "econsys": 0,
      ...
      {
	        "question": "Organisations and corporations cannot be trusted and thus need regulating by the government.",
	        "effect": {
	            "econ": -10,
	            "govt": 0,
	            "econsys": 0,
	    ...
	    },
  {
      ...
      {
	        "question": "The community should collectively bear economic profits and losses.",
	        "effect": {
	            "econ": -10,
	            "govt": 0,
	            "econsys": -10,
	    ...
	    //Governmental
	    {
	        ...
	        "effect": {
	            "econ": 0, "govt": 10, "econsys": 0, "econreg": 0,
	            "govttype": -10,
	            "govtsize": 0,
               "diplapp": 0,
               "diplrel": 0,
		...
		{
	        "question": "Electoral votes needs to be adjusted so that different states/regions get representation.",
	        "effect": {
	        "econ": 0,
	        "govt": -5,
	        "govttype": -10,
		...
		{
	        "question": "Democracy increases the risks of instability and corruption.",
	        "effect": {
	        "econ": 0,
	        "govt": 10,
	        "govttype": -10,
		...
		{
	        "question": "Democratic governments are often inefficient.",
	        "effect": {
	        "econ": 0,
	        "govt": 10,
	        "govttype": -10,
		...
		{
	        "question": "Only allowing scientific experts to run for an election is preferable than that of a regular democracy.",
	        "effect": {
	        "econ": 0,
	        "govt": 0,
	        "govttype": -10,
		...
		{
	        "question": "Strength and substantial authority is required for a successful and efficient government.",
	        "effect": {
	        "econ": 0,
	        "govt": 10,
	        "govttype": 0,
		...
		{
	        "question": "Many problems in society are often solved quickly and easily by a large government.",
	        "effect": {
	        "econ": 0,
	        "govt": 10,
	        "govttype": 0,
		...
		{
	        "question": "Libertarianism and Anarchism are unrealistic ideas that would never work in practise.",
	        "effect": {
	        "econ": 0,
	        "govt": 10,
	        "govttype": 0,
		...
		{
	        "question": "If a person has nothing to hide, that person has nothing to fear.",
	        "effect": {
	        "econ": 0,
	        "govt": 10,
	        "govttype": 0,
		...
		{
	        "question": "Martial law is appropiate if a nation is undergoing a crisis.",
	        "effect": {
	        "econ": 0,
	        "govt": 10,
	        "govttype": 0,
		...
		{
	        "question": "Victimless crimes should not be considered 'crimes'.",
	        "effect": {
	        "econ": 0,
	        "govt": -10,
	        "govttype": 0,
		...
		{
	        "question": "Any drug should be legal as long as people are informed that it is a drug.",
	        "effect": {
	        "econ": 0,
	        "govt": -10,
	        "govttype": 0,
		...
		{
	        "question": "Democratic governments are still oppressive.",
	        "effect": {
	        "econ": 0,
	        "govt": -10,
	        "govttype": 0,
	        "govtsize": -10,
      		...
      		{
	        "question": "Environmental activism and social pressure are a more effective way of saving the environment when compared to government action.",
	        "effect": {
	            "econ": 0,
	            "govt": -10,
	            "govttype": 0,
		...
		{
	        "question": "Governments should stay out of the people's daily lives.",
	        "effect": {
	        "econ": 0,
	        "govt": -10,
	        "govttype": 0,
	    ...
	    },
	{
		...
		{
	        "question": "I support the Black Lives Matter organization.",
	        "effect": {
	        "econ": -2, "govt": 0, "econsys": 0, "econreg": 0, "govtsize": 0, "govttype": 0, "diplapp": 0, "diplrel": 0,
                "sctytrad": -10,
                "sctychg": 0,
